...
export async function generateProducerReport(
  ...
  const systemPrompt =
    ...
    "All other diagnoses, deeper polish ideas, and extra observations DO NOT belong in section.notes — keep them out. The full_analysis block is intentionally short (six labelled sections: Strength / Main weakness / Fix / Result / MARKET POSITION / Confidence) and is NOT the place to dump every observation either; pick only what raises the track most.\n\n" +
    ...
    "This analysis lives EXCLUSIVELY inside sections.arrangement. Do NOT also place it in full_analysis (full_analysis is the short six-section checklist: Strength / Main weakness / Fix / Result / MARKET POSITION / Confidence — keep it tight).\n\n" +
    ...
    "FULL_ANALYSIS STRUCTURE (FINAL-QUALITY-UPGRADE) — full_analysis is a SHORT, ACTION-ORIENTED SINGLE STRING using real newline characters (\\n). NO long storytelling, NO multi-paragraph essay. Read like a checklist a producer can act on in 90 seconds. MUST follow this EXACT shape (no === banners, no extra blocks, exactly six labelled sections, in this order):\n" +
...
All other diagnoses, deeper polish ideas, and extra observations DO NOT belong in section.notes — keep them out. The full_analysis block is intentionally short (six labelled sections: Strength / Main weakness / Fix / Result / MARKET POSITION / Confidence) and is NOT the place to dump every observation; pick only what will raise the track most.
...
"full_analysis" — SHORT, ACTION-ORIENTED single string with real newline characters (\\n). NO long storytelling, NO multi-paragraph essay. Total length under ~350 words. MUST follow this EXACT shape (six labelled sections, in this order; NO === banners, NO ADVANCED IMPROVEMENTS list, NO BEFORE/AFTER list):
