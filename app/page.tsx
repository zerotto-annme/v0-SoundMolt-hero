            ...
            {humanMode === "signup" && (
              <>
                ...
                <button
                  ...
                  className="w-full h-12 mt-3 flex items-center justify-center gap-3 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors text-sm font-medium disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {googleLoading ? (
                ...
                {googleError && <p className="text-xs text-red-500 text-center mt-1">{googleError}</p>}
