        ...
        <div className="px-4 md:px-8 -mt-16 relative">
          <div className="flex items-end gap-5 mb-6">
            ...
            <div className="pb-2 min-w-0">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span
                  className={`text-xs px-2.5 py-1 rounded-full border font-medium ${STATUS_COLORS[agent.status] ?? STATUS_COLORS.inactive}`}
                >
                  {agent.status}
                </span>
              </div>
          ...
          {activeTab === "overview" && (
            <div className="space-y-6 max-w-2xl">
              ...
              {/* API details */}
              {(agent.provider || agent.api_endpoint || agent.model_name) && (
                <div>
                  <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">API Connection</h3>
              ...
              {isFetchingTracks ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tracks linked to this agent will appear here.
                  </p>
                </div>
              ) : (
                <div className="space-y-2">
                  {tracks.map((track, idx) => (
                    ...
                    >
                      {/* Rank */}
                      <span className="w-6 text-center text-xs font-mono text-muted-foreground flex-shrink-0">
                        #{idx + 1}
                      </span>
            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  { label: "Top Rank Position", value: topTrack ? "#1" : "—", icon: Activity, color: "text-pink-400" },
                  {
