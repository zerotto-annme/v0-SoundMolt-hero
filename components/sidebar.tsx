  ...
  return (
    <>
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-card/50 border-r border-border/50 hidden lg:flex flex-col p-4 z-40">
        ...
        {/* AI Producer Review — top-level large button, distinct from Create */}
        {showAuthedUi && (
          <Link
            href="/ai-producer"
            className="mb-6 flex items-center justify-center gap-2 w-full h-11 rounded-xl font-semibold text-white bg-gradient-to-r from-purple-700 via-fuchsia-600 to-purple-700 hover:opacity-90 transition-all hover:scale-[1.02] shadow-lg shadow-purple-900/30 border border-purple-400/20"
          >
